    ...
    <>
      <FooterWrap>
        <FooterMenus
          ...
          style={{ color: pathFlag === "root" ? "#94DA76" : "#DDDDDD" }}
        >
          {pathFlag === "root" ? <Community_On /> : <Community_Off />}
          <span>커뮤니티</span>
        </FooterMenus>
        <FooterMenus
          onClick={() => {
          ...
          style={{ color: pathFlag === "info" ? "#94DA76" : "#DDDDDD" }}
        >
        ...
        <FooterMenus
          ...
          style={{ color: pathFlag === "mypage" ? "#94DA76" : "#DDDDDD" }}
        >
          {pathFlag === "mypage" ? <Mypage_On /> : <Mypage_Off />}
          <span>{usercookie === undefined ? "로그인" : "내정보"}</span>
        </FooterMenus>
      </FooterWrap>
    </>
  );
