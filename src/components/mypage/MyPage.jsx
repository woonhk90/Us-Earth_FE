...
import {
  __postNickNameOverlap,
  __postNickNameSubmit,
  resetOverlap,
        ...
        <Container>
          <MyPageInfo>
            <MyPageInfoBox>
              {userNick ? (
                <NickChangeTrue>
                  ...
                  />
                  <span>
                    <Check onClick={onNickNameSubmit} />{" "}
                    <CheckCancel onClick={onChangeNick} />
                  </span>
                  {overlapFlag ? (
                    <P>가능한 닉네임입니다.</P>
                  ) : (
                    <P color={"red"}>불가능한 닉네임입니다.</P>
                  )}
                </NickChangeTrue>
              ) : (
                <NickChangeFalse>
                  {userInfo?.nickname}{" "}
                  <span onClick={onChangeNick}>
                    수정 <NickNameArrow />
                  </span>
                </NickChangeFalse>
              )}
            ...
            <MyPageProFile>
              ...
              />
              <ProfileSearch onClick={onChangeProfile}>
                <IconUpdate />
              </ProfileSearch>
            </MyPageProFile>
          </MyPageInfo>
          ...
          <MyPageMissionList>
            <MyPageMissionListBox>
              <div>나의 미션 목록</div>
              <div onClick={() => navigate("/mypage/mission/week")}>
                <span>
                  <Chart />
                  <span>개인 미션 통계</span>
                </span>
              ...
              <div onClick={() => navigate("/mypage/mission/group")}>
                <span>
                  <Group />
                  <span>그룹 미션</span>
                </span>
...
const ProfileSearch = styled.form`
  ...
  padding: 5px;
  box-sizing: border-box;
  background-color: ${colors.black52};
  cursor: pointer;
  display: flex;
  align-items: center;
