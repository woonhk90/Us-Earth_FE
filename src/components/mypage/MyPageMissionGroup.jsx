    ...
    <>
      <GroupWrap>
        <Container>
          <CategoryBox>
            <Button
              btnType="missionGroupMenu"
              onClick={() => {
                onClickCategory("ongoing");
              }}
              active={categoryFlag}
              name="ongoing"
            >
            ...
            {writer ? (
              <>
                {myGroupList
                  .filter(
                    (v) =>
                      v.dateStatus === saveCagegoryFlag && v.writer === true
                  )
                  .map((v) => (
                    <ListBox
                      key={v.communityId}
                      onClick={() =>
                        navigate(`/community/detail/${v.communityId}`)
                      }
                    >
                      <ItemImg
                        bgImg={
              ...
              <>
                {myGroupList
                  .filter((v) => v.dateStatus === saveCagegoryFlag)
                  .map((v) => (
                    <ListBox
                      key={v.communityId}
                      onClick={() =>
